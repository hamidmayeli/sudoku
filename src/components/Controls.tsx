  ...
  return (
    <div className="controls">
      ...
      <div className="expandable-sections">
        ...
        {showDifficultyMenu === "newGame" && (
          <div className="difficulty-menu">
            <button onClick={() => { onRestartGame(); setShowDifficultyMenu(null); }}>Restart Current Game</button>
      ...
      <div className="controls-row">
        ...
        <button onClick={onTakeSnapshot} disabled={isComplete} title="Save current state" className="snapshot-button">
          <svg width="20px" height="20px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          {snapshotCount > 0 && (
            <span className="snapshot-count-badge" aria-label={`${snapshotCount} snapshots saved`}>
              {snapshotCount}
            </span>
          )}
        </button>
